...
- (void)initElement
{
    ...
    // タイトル
    UIFont* titleFont = [UIFont fontWithName:@"HelveticaNeue-Light"
                                        size:18]; //UltraLight
    ...
    _backgroundView.backgroundColor = [UIColor colorWithRed:1
                                                      green:1
                                                       blue:1
                                                      alpha:1.0];
    ...
    _checkImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"icon_table_selected"]];
}
        ...
        cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    cell.textLabel.highlightedTextColor = [UIColor colorWithRed:0.10196078431372549
    ...
    if (indexPath.row == 0) {
        ...
        _checkImageView.frame = CGRectMake(cell.frame.size.width - frame.size.width - 15, cell.center.y - frame.size.height / 2, frame.size.width, frame.size.height);
    }
