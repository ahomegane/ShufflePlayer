...
- (void)initElement
{
    ...
    UIColor* linkColor = [UIColor colorWithRed:0.3803921568627451
                                         ...
                                         alpha:1.0];
    UIColor* bgPickerView = [UIColor colorWithRed:0.624
                                            green:0.624
                                             blue:0.624
                                            alpha:1];
    ...
    _selectedTimeLabel.font = [UIFont fontWithName:@"HelveticaNeue-UltraLight"
                                              size:87.5];
    ...
    _timeLabelMessage.font = [UIFont fontWithName:@"HelveticaNeue-Light"
                                             size:12];
    ...
    UIFont* buttonFont = [UIFont fontWithName:@"HelveticaNeue-Light"
                                         size:20]; //UltraLight
    ...
    [saveButton setTitleColor:linkColor
                     forState:UIControlStateNormal];
    ...
    [clearButton setTitleColor:linkColor
                      forState:UIControlStateNormal];
